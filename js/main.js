...
jQuery(document).on("ready", function () {
    ...
    _tg_upcomingeventcounter.countdown("2021/02/20", function (event) {
    ...
    _tg_upcomingeventcountervtwo.countdown("2021/02/20", function (event) {
        var $this = jQuery(this).html(
            event.strftime(
                "" +
    ...
    var _tg_eventspeakersliders = jQuery("#tg-eventspeakersliders");
    _tg_eventspeakersliders.owlCarousel({
        loop: true,
        nav: false,
        animateIn: "fadeIn",
        autoplay: false,
